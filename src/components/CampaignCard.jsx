    ...
    <div className="bg-white rounded-xl border border-coffee-200 p-5 hover:shadow-md transition-all">
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          <h3 className="font-semibold text-coffee-900 mb-1">{campaign.nama}</h3>
          <p className="text-sm text-coffee-600 line-clamp-2">{campaign.deskripsi}</p>
        </div>
        <span
      ...
      <div className="pt-3 border-t border-coffee-100 flex items-center justify-between text-sm">
        <span className="text-coffee-600">
          <span className="font-semibold text-coffee-900">{campaign.jumlahPengguna}</span> dari{" "}
